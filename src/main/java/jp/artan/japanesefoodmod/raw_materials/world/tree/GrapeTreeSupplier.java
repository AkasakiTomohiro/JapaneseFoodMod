...
public class GrapeTreeSupplier extends WorldGenSupplier {
    ...
    public WorldGenFruitTrees getWorldGenerate(boolean parShouldNotify) {
        return new GrapeTreeGen(parShouldNotify, this.log, this.leaves, this.fruitBlock);
    }
...
class GrapeTreeGen extends WorldGenFruitTrees {

    public GrapeTreeGen(boolean parShouldNotify, FruitLog log, FruitLeaves leaves, FruitBlock fruitBlock) {
