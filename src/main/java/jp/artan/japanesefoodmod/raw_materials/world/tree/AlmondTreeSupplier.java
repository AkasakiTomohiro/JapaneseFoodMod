...
public class AlmondTreeSupplier extends WorldGenSupplier {
    private FruitLog log;
    private FruitLeaves leaves;
    private FruitBlock fruitBlock;

    public AlmondTreeSupplier() {
        super(100);
    }

    @Override
    public WorldGenFruitTrees getWorldGenerate(boolean parShouldNotify) {
        return new AlmondTreeGen(parShouldNotify, this.log, this.leaves, this.fruitBlock);
    }
...
class AlmondTreeGen extends WorldGenFruitTrees {

    public AlmondTreeGen(boolean parShouldNotify, FruitLog log, FruitLeaves leaves, FruitBlock fruitBlock) {
