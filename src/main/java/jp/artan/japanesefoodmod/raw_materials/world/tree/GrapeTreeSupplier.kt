...
class GrapeTreeSupplier : WorldGenSupplier(Blocks.GRASS, 100) {
    ...
    override fun getWorldGenerate(parShouldNotify: Boolean): WorldGenFruitTrees {
        return GrapeTreeGen(parShouldNotify, this.log, this.leaves, this.fruitBlock)
    }
...
class GrapeTreeGen(parShouldNotify: Boolean, log: FruitLog, leaves: FruitLeaves, fruitBlock: FruitBlock) :
