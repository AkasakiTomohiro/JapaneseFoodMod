...
class JuglansTreeSupplier : WorldGenSupplier(Blocks.GRASS, 100) {
    ...
    override fun getWorldGenerate(parShouldNotify: Boolean): WorldGenFruitTrees {
        return JuglansTreeGen(parShouldNotify, this.log, this.leaves, this.fruitBlock)
    }
...
class JuglansTreeGen(parShouldNotify: Boolean, log: FruitLog, leaves: FruitLeaves, fruitBlock: FruitBlock) :
