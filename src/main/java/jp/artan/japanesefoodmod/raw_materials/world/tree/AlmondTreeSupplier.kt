...
class AlmondTreeSupplier : WorldGenSupplier(Blocks.GRASS, 100) {
    ...
    override fun getWorldGenerate(parShouldNotify: Boolean): WorldGenFruitTrees {
        return AlmondTreeGen(parShouldNotify, this.log, this.leaves, this.fruitBlock)
    }
...
class AlmondTreeGen(parShouldNotify: Boolean, log: FruitLog, leaves: FruitLeaves, fruitBlock: FruitBlock) :
